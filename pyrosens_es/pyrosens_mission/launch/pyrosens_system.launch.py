...
def generate_launch_description():
    ...
    nav2_map_arg = DeclareLaunchArgument(
        "nav2_map",
        default_value="",
        description="Optional Nav2 map YAML path.",
    )
    ...
    bridge_node = Node(
        ...
        output="screen",
        arguments=[
            # Mission status exported to Gazebo consumers
            "/mission/status@std_msgs/msg/String@gz.msgs.StringMsg@ros2_to_gz",
            "/mission/goals@std_msgs/msg/String@gz.msgs.StringMsg@ros2_to_gz",
            # GUI command channel (Gazebo -> ROS)
            "/mission/cmd@std_msgs/msg/String@gz.msgs.StringMsg@gz_to_ros2",
            # Goal ingestion from Gazebo systems
            "/mission/load_goals@geometry_msgs/msg/PoseArray@gz.msgs.Pose_V@gz_to_ros2",
            # Wind and thermal telemetry (Gazebo -> ROS, adjust to match sensors in use)
            "/wind/test_cloud@sensor_msgs/msg/PointCloud2@gz.msgs.PointCloudPacked@gz_to_ros2",
            "/heat/temperature@sensor_msgs/msg/Temperature@gz.msgs.Temperature@gz_to_ros2",
            "/sim/wind@std_msgs/msg/String@gz.msgs.StringMsg@ros2_to_gz",
        ],
    )
